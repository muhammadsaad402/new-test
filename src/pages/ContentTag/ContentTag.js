...
export default function ContentData() {
  ...
  useEffect(() => {
    axios({
      method: 'GET',
      url: `${baseUrl}/api/v1/admin/get-content-tag`,
  ...
  const handleDeleteContent = () => {
    axios({
      method: 'DELETE',
      url: `${baseUrl}/api/v1/admin/delete-content-tag/${currentContentId}`,
      withCredentials: true,
    })
      .then((res) => {
        console.log(res.data);
  ...
  const handleClickName = (item) => {
    navigate(`/dashboard/update-tags/${item._id}`, { state: item });
  };
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, title: name, status, tags, avatarUrl } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <UserMoreMenu item={row} page="tags" deleteHandler={handleConfirmationDialogOpen} />
                        </TableCell>
                      </TableRow>
                    );
                  })}
