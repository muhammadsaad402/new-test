...
function UpdateContentTags() {
  ...
  const handleUpdateContent = () => {
    axios({
      method: 'PUT',
      url: `${baseUrl}/api/v1/admin/update-content-tag/${id}`,
      data: updatedData,
  ...
  const userSchema = Yup.object().shape({
    tags: Yup.string().min(2, 'must be atleast 4 characters').required('Email is required'),
  });
...
export default UpdateContentTags;
